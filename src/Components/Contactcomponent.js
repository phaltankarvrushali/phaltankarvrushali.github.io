...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        if (name.current.value==='' || email.current.value==='' || message.current.value===''){
            ...
            emailjs.sendForm('service_qq2ic5u', 'template_hqzc2i9', form.current, 'wNxxKbLaHbx5_4qJP')
            .then((result) => {
    ...
    const position = [42.346858,-71.09359];
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-2">
                                            ...
                                            <a href="https://www.facebook.com/vrushaliphaltankar" target="_blank"> <FontAwesomeIcon icon={faFacebook} color="#4267B2" size="2x" /> </a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                        <div className="col-2">
                                        <   MouseParallaxContainer>
                                            <MouseParallaxChild factorX={0.1} factorY={0.1} >
                                            <a href="https://www.instagram.com/vrushaliphaltankar/" target="_blank"><FontAwesomeIcon icon={faInstagram} color="#cd486b" size="2x"/></a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                        <div className="col-2">
                                            <MouseParallaxContainer>
                                            <MouseParallaxChild factorX={0.1} factorY={0.1} >
                                            <a href="https://www.linkedin.com/in/vrushaliphaltankar/" target="_blank"><FontAwesomeIcon icon={faLinkedin} color="#0072b1" size="2x"/></a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                        <div className="col-2">
                                            <MouseParallaxContainer>
                                            <MouseParallaxChild factorX={0.1} factorY={0.1} >
                                            <a href="mailto:phaltankarvrushali70@gmail.com" target="_blank"><FontAwesomeIcon icon={faGoogle}  color="#3cba54" size="2x"/></a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                        <div className="col-2">
                                            <MouseParallaxContainer>
                                            <MouseParallaxChild factorX={0.1} factorY={0.1} >
                                            <a href="https://twitter.com/vrushali" target="_blank"><FontAwesomeIcon icon={faTwitter} color="#00acee" size="2x"/></a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                        <div className="col-2">
                                            <MouseParallaxContainer>
                                            <MouseParallaxChild factorX={0.1} factorY={0.1} >
                                            <a href="https://github.com/phaltankarvrushali" target="_blank"><FontAwesomeIcon icon={faGithub}  color="white" size="2x"/></a>
                                            </MouseParallaxChild>
                                            </MouseParallaxContainer>
                                        </div>
                                    </div>
